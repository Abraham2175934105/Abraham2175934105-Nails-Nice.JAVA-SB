...
const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulación de login - aquí integrarás tu backend
    setTimeout(() => {
      toast({
        title: "¡Bienvenida!",
      ...
      <div className="w-full max-w-md animate-scale-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">
            Inicia sesión para continuar con tu belleza
          </p>
        </div>
        ...
        <div className="bg-card rounded-2xl shadow-deep border border-border p-8 hover-glow">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-12 gradient-primary text-primary-foreground font-semibold hover:shadow-glow hover:scale-[1.02] transition-bounce text-base"
            >
              {isLoading ? (
